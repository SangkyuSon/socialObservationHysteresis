...
for m = 1:NoS,    
    cnt = cnt + 1;
    load(fullfile(dataDir,sprintf('raw_exp%d_S%02d.mat',expNo,m)));
...
figure
subplot(1,3,1:2)
hold on; cellfun(@(x1,x2) shadedplot_custom(x1,NoS,'xAxis',fitout.fitx,'Color',x2),groupPsyMet,condCols)
